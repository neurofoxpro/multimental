...
func _initialize() -> void:
    ...
    var result: Dictionary = game.apply(who, {"type": "play", "hand": 0, "cell": 5, "direction": 0})
    ...
    check(game.state.board[0] != null and game.state.board[1] == null, "lethal opening hit prevents counterattack")
