export function assertQualification(report,{head,apkHash,toolDigest,physical=false}){
 ...
 const names=['emulator-A-install','emulator-A-ui','emulator-A-jni','emulator-A-reinstall','emulator-B-install','emulator-B-ui','emulator-B-jni','emulator-B-reinstall','emulator-pair'];
