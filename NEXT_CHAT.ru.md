> АКТУАЛЬНО 24.09.2026: PR15/17 завершены, v0.3.0-alpha.88.1 опубликована и установлена. Кандидат прошёл 29/29. Secure Windows guest ↔ Android host подтверждён; следующий аппаратный рубеж — второй физический Android для Android guest/phone-to-phone. См. docs/production/BLUETOOTH_RELEASE_COMPLETED.ru.md. Старые USB/pairing-блокеры ниже исторические. Не перезапускать cycle закрытых PR; читать live состояние.

> ОБНОВЛЕНО 24.09.2026: PR17 завершён, v0.2.1-alpha.82.1 опубликована и фактически установлена. Полная квалификация 28/28. USB-согласие и Bluetooth-пара восстановлены. Продолжать PR15 в repo-beta; не запускать production cycle закрытого PR17. Подробнее: docs/production/TUTORIAL_RELEASE_82.ru.md. Нижние снимки исторические; свежая проверка состояния обязательна.
